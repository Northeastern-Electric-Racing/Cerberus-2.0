...
/* Pedal Tuning */
#define MAX_APPS1_VOLTS		    3.45 // (Volts). Upper bound on APPS1 voltage range.
#define MIN_APPS1_VOLTS		    2.2 // (Volts). Lower bound on APPS1 voltage range.
#define MAX_APPS2_VOLTS		    2.25 // (Volts). Upper bound on APPS2 voltage range.
