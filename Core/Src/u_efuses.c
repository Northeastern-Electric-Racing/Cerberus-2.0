...
static const _metadata efuses[] = {
    ...
    [EFUSE_PUMP2] = {.en_pin = EF_PUMP2_EN_Pin, .en_port = EF_PUMP2_EN_GPIO_Port, .er_pin = EF_PUMP2_ER_Pin, .er_port = EF_PUMP2_ER_GPIO_Port, .scale = SCALE(47), .default_state = EF_OFF},
    [EFUSE_BATTBOX] = {.en_pin = EF_BATTBOX_EN_Pin, .en_port = EF_BATTBOX_EN_GPIO_Port, .er_pin = EF_BATTBOX_ER_Pin, .er_port = EF_BATTBOX_ER_GPIO_Port, .scale = SCALE(56), .default_state = EF_OFF},
    [EFUSE_MC] = {.en_pin = EF_MC_EN_Pin, .en_port = EF_MC_EN_GPIO_Port, .er_pin = EF_MC_ER_Pin, .er_port = EF_MC_ER_GPIO_Port, .scale = SCALE(56), .default_state = EF_OFF},
    [EFUSE_SPARE] = {.en_pin = EF_SPARE_EN_Pin, .en_port = EF_SPARE_EN_GPIO_Port, .er_pin = EF_SPARE_ER_Pin, .er_port = EF_SPARE_ER_GPIO_Port, .scale = 0, .default_state = EF_OFF}
};
