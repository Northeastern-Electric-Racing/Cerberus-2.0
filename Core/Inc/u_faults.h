...
bool get_fault(
	fault_t fault); /* Returns whether or not a specific fault is active. */
void write_mcu_fault(
	bool status); /* Write the VCU FAULT line (from the microcontroller to the car). true = faulted, false = unfaulted. */
