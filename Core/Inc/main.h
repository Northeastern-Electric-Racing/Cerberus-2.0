...
#define I2C2_SDA_R_Pin GPIO_PIN_0
#define I2C2_SDA_R_GPIO_Port GPIOF
#define I2C2_SCL_R_Pin GPIO_PIN_1
#define I2C2_SCL_R_GPIO_Port GPIOF
...
#define ETH_RMII_TX_EN_Pin GPIO_PIN_5
#define ETH_RMII_TX_EN_GPIO_Port GPIOA
#define ADC12_INP3_Pin GPIO_PIN_6
#define ADC12_INP3_GPIO_Port GPIOA
#define ETH_RMII_TX_ENA7_Pin GPIO_PIN_7
#define ETH_RMII_TX_ENA7_GPIO_Port GPIOA
...
#define SPI2_MOSI_R_Pin GPIO_PIN_1
#define SPI2_MOSI_R_GPIO_Port GPIOG
...
#define EF_BREAK_EN_Pin GPIO_PIN_8
#define EF_BREAK_EN_GPIO_Port GPIOD
#define EF_BREAK_ER_Pin GPIO_PIN_9
...
#define CKPT_GPIO_GPIO_Port GPIOG
#define INERTIA_SW_GPIO_Pin GPIO_PIN_3
#define INERTIA_SW_GPIO_GPIO_Port GPIOG
#define EF_RADFAN_EN_Pin GPIO_PIN_4
#define EF_RADFAN_EN_GPIO_Port GPIOG
#define EF_RADFAN_ER_Pin GPIO_PIN_5
#define EF_RADFAN_ER_GPIO_Port GPIOG
#define EF_SHUTDOWN_EN_Pin GPIO_PIN_6
#define EF_SHUTDOWN_EN_GPIO_Port GPIOG
#define EF_SHUTDOWN_ER_Pin GPIO_PIN_7
#define EF_SHUTDOWN_ER_GPIO_Port GPIOG
#define IMU_INT1_Pin GPIO_PIN_8
#define IMU_INT1_GPIO_Port GPIOA
#define LPUART1_TX_R_Pin GPIO_PIN_9
#define LPUART1_TX_R_GPIO_Port GPIOA
#define LPUART1_RX_R_Pin GPIO_PIN_10
#define LPUART1_RX_R_GPIO_Port GPIOA
#define IMU_INT2_Pin GPIO_PIN_11
#define IMU_INT2_GPIO_Port GPIOA
#define SPI2_SCK_R_Pin GPIO_PIN_12
#define SPI2_SCK_R_GPIO_Port GPIOA
...
#define RTDS_GPIO_Pin GPIO_PIN_2
#define RTDS_GPIO_GPIO_Port GPIOD
...
#define TSMS_GPIO_Pin GPIO_PIN_9
#define TSMS_GPIO_GPIO_Port GPIOG
#define EF_SPARE_EN_Pin GPIO_PIN_10
#define EF_SPARE_EN_GPIO_Port GPIOG
#define EF_SPARE_ER_Pin GPIO_PIN_11
#define EF_SPARE_ER_GPIO_Port GPIOG
